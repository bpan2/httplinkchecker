...
public class ArgParser {
	...
	/*
	 * Deprecated: public ArrayList<String> retrieveAllAbsoluteFilePaths(String
	 * path) { File f = new File(path); File[] files = f.listFiles();
	 * 
	...
	public void print2DArrayList(ArrayList<ArrayList<String>> allPathsByDirectory) {
