...
public static int MAXNUMPATHS = 10;
	...
	public static void main(String[] args) {		
		...
		String[] cmdarg = {"url-list"};
		
		//.........................................................................
		//1. based on file names, and options, get all absolute paths to the files
		ArgParser ap = new ArgParser(cmdarg);
		/*
		 * System.out.print("dirPaths: "); msg.displyMessage("Element", 0,
		 * ap.getDirPaths(), 0);
		 * 
		 * System.out.print("fileNames: "); msg.displyMessage("Element", 0,
		 * ap.getFileNames(), 0);
		 * 
		 * System.out.print("options: "); msg.displyMessage("Element", 0,
		 * ap.getOptions(), 0);
		 */
